...
mod uniswap_exchange {
    ...
    use damnvulnerabledefi::contracts::dependencies::external::token::ERC20::{
        ERC20, IERC20, IERC20Dispatcher, IERC20DispatcherTrait
    };
    use damnvulnerabledefi::contracts::dependencies::external::token::ERC20::ERC20::{
        ERC20 as ERC20Impl, PrivateImpl as PrivateERC20Impl,
    };
    ...
    impl UniswapPrivateERC20Impl of UniswapPrivateERC20Trait {
        fn _initializer(name: felt252, symbol: felt252) {
            let mut state = ERC20::unsafe_new_contract_state();
    ...
    impl UniswapExchangeImpl of IUniswapExchange<ContractState> {
        fn setup(
            ref self: ContractState, token_addr: ContractAddress, ether_token_addr: ContractAddress
        ) {
            ...
            self
                .factory
                .write(
                    IUniswapFactoryDispatcher { contract_address: starknet::get_caller_address() }
                );
            self.token.write(IERC20Dispatcher { contract_address: token_addr });
            self.ether_token.write(IERC20Dispatcher { contract_address: ether_token_addr });

            UniswapPrivateERC20Impl::_initializer('Uniswap V1', 'UNI-V1');
        }
        ...
        fn get_output_price(
            self: @ContractState, output_amount: u256, input_reserve: u256, output_reserve: u256
        ) -> u256 {
        ...
        fn eth_to_token_transfer_input(
            ...
            UniswapExchangePrivateImpl::eth_to_token_input(
                ref self, value, min_tokens, deadline, caller, recipient
            )
        }


        fn eth_to_token_swap_output(
            ref self: ContractState, value: u256, tokens_bought: u256, deadline: u256
        ) -> u256 {
            let caller = starknet::get_caller_address();
            UniswapExchangePrivateImpl::_receive_ether(ref self, caller, value);

            UniswapExchangePrivateImpl::eth_to_token_output(
                ref self, tokens_bought, value, deadline, caller, caller
            )
        }
        ...
        fn eth_to_token_transfer_output(
            ...
            UniswapExchangePrivateImpl::eth_to_token_output(
                ref self, tokens_bought, value, deadline, caller, recipient
            )
        }


        fn token_to_eth_swap_input(
            ref self: ContractState, tokens_sold: u256, min_eth: u256, deadline: u256
        ) -> u256 {
            let caller = starknet::get_caller_address();
            UniswapExchangePrivateImpl::token_to_eth_input(
                ref self, tokens_sold, min_eth, deadline, caller, caller
            )
        }
        ...
        fn token_to_eth_transfer_input(
            ...
            let caller = starknet::get_caller_address();
            UniswapExchangePrivateImpl::token_to_eth_input(
                ref self, tokens_sold, min_eth, deadline, caller, recipient
            )
        }


        fn token_to_eth_swap_output(
            ref self: ContractState, eth_bought: u256, max_tokens: u256, deadline: u256
        ) -> u256 {
            let caller = starknet::get_caller_address();
            UniswapExchangePrivateImpl::token_to_eth_output(
                ref self, eth_bought, max_tokens, deadline, caller, caller
            )
        }
        ...
        fn token_to_eth_transfer_output(
            ...
            let caller = starknet::get_caller_address();
            UniswapExchangePrivateImpl::token_to_eth_output(
                ref self, eth_bought, max_tokens, deadline, caller, recipient
            )
        }
        ...
        fn get_eth_to_token_input_price(self: @ContractState, eth_sold: u256) -> u256 {
            ...
            UniswapExchangeImpl::get_input_price(
                self, eth_sold, self.ether_token_balance.read(), token.balance_of(this)
            )
        }
        ...
        fn get_eth_to_token_output_price(self: @ContractState, tokens_bought: u256) -> u256 {
            ...
            let eth_sold = UniswapExchangeImpl::get_output_price(
                self, tokens_bought, self.ether_token_balance.read(), token.balance_of(this)
            );
        ...
        fn get_token_to_eth_input_price(self: @ContractState, tokens_sold: u256) -> u256 {
            ...
            let eth_bought = UniswapExchangeImpl::get_input_price(
                self, tokens_sold, token.balance_of(this), self.ether_token_balance.read()
            );
        ...
        fn get_token_to_eth_output_price(self: @ContractState, eth_bought: u256) -> u256 {
            ...
            UniswapExchangeImpl::get_output_price(
                self, eth_bought, token.balance_of(this), self.ether_token_balance.read()
            )
        }
        ...
        fn add_liquidity(
            ...
            assert(
                deadline > get_block_timestamp().into() && max_tokens > 0 && value > 0,
                'INVALID_ARGUMENT'
            );
            ...
            if (total_liquidity > 0) {
                ...
                self
                    .emit(
                        Event::AddLiquidity(
                            AddLiquidity {
                                provider: caller, eth_amount: value, token_amount: token_amount
                            }
                        )
                    );
        ...
        fn remove_liquidity(
            ref self: ContractState, amount: u256, min_eth: u256, min_tokens: u256, deadline: u256
        ) -> (u256, u256) {
            assert(
                amount > 0
            ...
            self
                .emit(
                    Event::RemoveLiquidity(
                        RemoveLiquidity {
                            provider: caller, eth_amount: eth_amount, token_amount: token_amount
                        }
                    )
                );
    ...
    impl UniswapExchangePrivateImpl of UniswapExchangePrivateTrait {
        fn eth_to_token_input(
            ...
            let tokens_bought = UniswapExchangeImpl::get_input_price(
                @self, eth_sold, eth_reserve, token_reserve
            );
            ...
            self
                .emit(
                    Event::TokenPurchase(
                        TokenPurchase {
                            buyer: buyer, eth_sold: eth_sold, tokens_bought: tokens_bought
                        }
                    )
                );
        ...
        fn eth_to_token_output(
            ...
            let eth_sold = UniswapExchangeImpl::get_output_price(
                @self, tokens_bought, ether_reserve - max_eth, token_reserve
            );
        ...
        fn token_to_eth_input(
            ...
            let eth_bought = UniswapExchangeImpl::get_input_price(
                @self, tokens_sold, token_reserve, eth_reserve
            );
            ...
            self
                .emit(
                    Event::EthPurchase(
                        EthPurchase {
                            buyer: buyer, tokens_sold: tokens_sold, eth_bought: wei_bought
                        }
                    )
                );
        ...
        fn token_to_eth_output(
            ...
            self
                .emit(
                    Event::EthPurchase(
                        EthPurchase {
                            buyer: buyer, tokens_sold: tokens_sold, eth_bought: eth_bought
                        }
                    )
                );
        ...
        fn token_to_token_input(
            ...
            }.eth_to_token_transfer_input(wei_bought, min_tokens_bought, deadline, recipient);
        ...
        fn token_to_token_output(
            ...
            let exchange = IUniswapExchangeDispatcher { contract_address: exchange_addr };
            ...
            let eth_sold = exchange
                .eth_to_token_transfer_output(eth_bought, tokens_bought, deadline, recipient);
        ...
        fn _receive_ether(ref self: ContractState, from: ContractAddress, value: u256) {
            ...
            self.ether_token_balance.write(self.ether_token_balance.read() + value);
        }
