...
mod test_puppet_pool {
    ...
    fn __setup_with_initial_liquidity() -> (
        ...
        ether_token.approve(
            uniswap_dvt_exchange.contract_address,
        ...
        uniswap_dvt_exchange.add_liquidity(
            UNISWAP_INITIAL_ETH_RESERVE(),
    ...
    fn __setup_exchange() -> (
        ...
        IPuppetPoolDispatcher
            ...
            ////////////////////////////////////////
            let uniswap_uniswap_dvt_exchange_address  = uniswap_factory.create_exchange(
                damn_valuable_token.contract_address
            );
            ...
            let puppet_pool = IPuppetPoolDispatcher{
                contract_address: puppet_pool_address
            };
